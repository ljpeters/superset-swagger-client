...
public class DatabaseValidateParametersSchema {
  ...
  **/
  @Schema(required = true, description = "Configuration_method is used on the frontend to inform the backend whether to explode parameters or to provide only a sqlalchemy_uri.")
  ...
  **/
   ...
   * @return engine
  **/
  @Schema(required = true, description = "SQLAlchemy engine to use")
