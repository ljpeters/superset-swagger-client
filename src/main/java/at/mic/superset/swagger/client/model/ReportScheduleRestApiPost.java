...
public class ReportScheduleRestApiPost {
  ...
  @SerializedName("selected_tabs")
  private List<Integer> selectedTabs = null;
  ...
  **/
   ...
   * @return crontab
  **/
  @Schema(example = "*_/5 * * * *", required = true, description = "A CRON expression.[Crontab Guru](https://crontab.guru/) is a helpful resource that can help you craft a CRON expression.")
  ...
  **/
  ...
  public ReportScheduleRestApiPost extra(Object extra) {
    this.extra = extra;
    return this;
  }
  ...
  **/
  ...
  public ReportScheduleRestApiPost forceScreenshot(Boolean forceScreenshot) {
  ...
  **/
   ...
   * @return name
  **/
  @Schema(example = "Daily dashboard email", required = true, description = "The report schedule name.")
  ...
  **/
  ...
  public ReportScheduleRestApiPost selectedTabs(List<Integer> selectedTabs) {
    this.selectedTabs = selectedTabs;
    return this;
  }

  public ReportScheduleRestApiPost addSelectedTabsItem(Integer selectedTabsItem) {
    if (this.selectedTabs == null) {
      this.selectedTabs = new ArrayList<Integer>();
    }
    this.selectedTabs.add(selectedTabsItem);
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public List<Integer> getSelectedTabs() {
    return selectedTabs;
  }

  public void setSelectedTabs(List<Integer> selectedTabs) {
    this.selectedTabs = selectedTabs;
  }
  ...
  **/
  ...
  public ReportScheduleRestApiPost timezone(TimezoneEnum timezone) {
  ...
  **/
   ...
   * @return type
  **/
  @Schema(required = true, description = "The report schedule type")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.active, reportScheduleRestApiPost.active) &&
        ...
        Objects.equals(this.extra, reportScheduleRestApiPost.extra) &&
        Objects.equals(this.forceScreenshot, reportScheduleRestApiPost.forceScreenshot) &&
        ...
        Objects.equals(this.selectedTabs, reportScheduleRestApiPost.selectedTabs) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, chart, contextMarkdown, creationMethod, crontab, dashboard, database, description, extra, forceScreenshot, gracePeriod, logRetention, name, owners, recipients, reportFormat, selectedTabs, sql, timezone, type, validatorConfigJson, validatorType, workingTimeout);
  }
  ...
  public String toString() {
    ...
    sb.append("    selectedTabs: ").append(toIndentedString(selectedTabs)).append("\n");
