...
import at.mic.superset.swagger.client.model.SavedQueryRestApiGetList;
...
public class InlineResponse20047 {
  ...
  private List<SavedQueryRestApiGetList> result = null;

  public InlineResponse20047 count(BigDecimal count) {
    this.count = count;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse20047 descriptionColumns(InlineResponse2001DescriptionColumns descriptionColumns) {
  ...
  **/
  ...
  public InlineResponse20047 ids(List<String> ids) {
    this.ids = ids;
    return this;
  }

  public InlineResponse20047 addIdsItem(String idsItem) {
    if (this.ids == null) {
  ...
  **/
  ...
  public InlineResponse20047 labelColumns(InlineResponse2001LabelColumns labelColumns) {
  ...
  **/
  ...
  public InlineResponse20047 listColumns(List<String> listColumns) {
    this.listColumns = listColumns;
    return this;
  }

  public InlineResponse20047 addListColumnsItem(String listColumnsItem) {
  ...
  **/
  ...
  public InlineResponse20047 listTitle(String listTitle) {
  ...
  **/
  ...
  public InlineResponse20047 orderColumns(List<String> orderColumns) {
    this.orderColumns = orderColumns;
    return this;
  }

  public InlineResponse20047 addOrderColumnsItem(String orderColumnsItem) {
  ...
  **/
  ...
  public InlineResponse20047 result(List<SavedQueryRestApiGetList> result) {
    this.result = result;
    return this;
  }

  public InlineResponse20047 addResultItem(SavedQueryRestApiGetList resultItem) {
    if (this.result == null) {
      this.result = new ArrayList<SavedQueryRestApiGetList>();
    }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, inlineResponse20047.count) &&
        Objects.equals(this.descriptionColumns, inlineResponse20047.descriptionColumns) &&
        Objects.equals(this.ids, inlineResponse20047.ids) &&
        Objects.equals(this.labelColumns, inlineResponse20047.labelColumns) &&
        Objects.equals(this.listColumns, inlineResponse20047.listColumns) &&
        Objects.equals(this.listTitle, inlineResponse20047.listTitle) &&
        Objects.equals(this.orderColumns, inlineResponse20047.orderColumns) &&
