...
import at.mic.superset.swagger.client.model.CssTemplateRestApiGetList;
...
public class InlineResponse20012 {
  ...
  private List<CssTemplateRestApiGetList> result = null;

  public InlineResponse20012 count(BigDecimal count) {
    this.count = count;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse20012 descriptionColumns(InlineResponse2001DescriptionColumns descriptionColumns) {
  ...
  **/
  ...
  public InlineResponse20012 ids(List<String> ids) {
    this.ids = ids;
    return this;
  }

  public InlineResponse20012 addIdsItem(String idsItem) {
    if (this.ids == null) {
  ...
  **/
  ...
  public InlineResponse20012 labelColumns(InlineResponse2001LabelColumns labelColumns) {
  ...
  **/
  ...
  public InlineResponse20012 listColumns(List<String> listColumns) {
    this.listColumns = listColumns;
    return this;
  }

  public InlineResponse20012 addListColumnsItem(String listColumnsItem) {
  ...
  **/
  ...
  public InlineResponse20012 listTitle(String listTitle) {
  ...
  **/
  ...
  public InlineResponse20012 orderColumns(List<String> orderColumns) {
    this.orderColumns = orderColumns;
    return this;
  }

  public InlineResponse20012 addOrderColumnsItem(String orderColumnsItem) {
  ...
  **/
  ...
  public InlineResponse20012 result(List<CssTemplateRestApiGetList> result) {
    this.result = result;
    return this;
  }

  public InlineResponse20012 addResultItem(CssTemplateRestApiGetList resultItem) {
    if (this.result == null) {
      this.result = new ArrayList<CssTemplateRestApiGetList>();
    }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, inlineResponse20012.count) &&
        Objects.equals(this.descriptionColumns, inlineResponse20012.descriptionColumns) &&
        Objects.equals(this.ids, inlineResponse20012.ids) &&
        Objects.equals(this.labelColumns, inlineResponse20012.labelColumns) &&
        Objects.equals(this.listColumns, inlineResponse20012.listColumns) &&
        Objects.equals(this.listTitle, inlineResponse20012.listTitle) &&
        Objects.equals(this.orderColumns, inlineResponse20012.orderColumns) &&
